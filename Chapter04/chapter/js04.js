...
function verifyMonths() {
   try {
      if(!(monthsBox.value > 0 && monthsBox.value <= 12)) throw "Enter a months between 1 and 12";
      testFormCompleteness();
   } catch(error) {
      messageElement.innerHTML = error;
      messageHeadElement.innerHTML = "";
